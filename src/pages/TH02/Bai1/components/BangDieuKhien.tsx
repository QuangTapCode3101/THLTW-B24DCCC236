  ...
  return (
    <div style={{ textAlign: 'center' }}>
      ...
      <Space size="large" style={{ marginTop: 20 }}>
        <Button size="large" type="primary" onClick={() => xuLyChon('Kéo')}>✌️ Kéo</Button>
        <Button size="large" type="primary" onClick={() => xuLyChon('Búa')} style={{ backgroundColor: '#52c41a', borderColor: '#52c41a' }}>✊ Búa</Button>
        <Button size="large" type="primary" onClick={() => xuLyChon('Bao')} style={{ backgroundColor: '#faad14', borderColor: '#faad14' }}>🖐️ Bao</Button>
      </Space>
